...
namespace Randomz
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            enemies.Add(new Enemy(Content.Load<Texture2D>("block"),new Vector2(700,700)));
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (rnd.Next(200) == 5)
                enemies.Add(new Enemy(Content.Load<Texture2D>("block"), new Vector2(rnd.Next((int)player.position.X, (int)player.position.X + 500), rnd.Next((int)player.position.Y, (int)player.position.Y + 500))));
